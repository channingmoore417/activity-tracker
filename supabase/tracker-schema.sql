...
create index if not exists activity_entries_user_metric_idx
...
drop trigger if exists set_activity_entries_updated_at on public.activity_entries;
...
drop policy if exists "Users can manage own activity entries" on public.activity_entries;
